...
<div x-data="{ notifications: [] }" 
    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8 mb-12">
        ...
        <a href="{{ route('reports.incidents.pdf') }}" class="inline-flex items-center px-8 py-4 bg-slate-900 text-white rounded-[1.5rem] font-black text-[10px] uppercase tracking-[0.2em] shadow-lg hover:-translate-y-1 transition-all">
